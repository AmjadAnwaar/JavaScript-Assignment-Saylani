...
var student_name = []
student_name.push("Syed Amjad Ali")
...
for (var i = 1; i <= quali.length; i++) {

    document.write(i + ") " + quali[i - 1] + "<br>")
}
